...
class ApiClient {
  ...
  Future<ApiResult<Map<String, dynamic>>> teacherStudents({required String stage, required int level}) async {
    return _get('/api/v1/teacher/students?stage=${Uri.encodeQueryComponent(stage)}&level=$level');
  }

...
class ApiClient {
  ...
  Future<ApiResult<Map<String, dynamic>>> teacherUpdateQuiz(int quizId, Map<String, dynamic> body) async => _patch('/api/v1/teacher/quizzes/$quizId', body);

  Future<ApiResult<Map<String, dynamic>>> teacherEndQuiz(int quizId) async => _post('/api/v1/teacher/quizzes/$quizId/end', {});

  Future<ApiResult<Map<String, dynamic>>> teacherDeleteQuiz(int quizId) async => _deleteWithBody('/api/v1/teacher/quizzes/$quizId', {});

            ...
            return AppScope(
              ...
              child: MaterialApp(
                ...
                builder: (context, child) => Directionality(
                  ...
                  child: _AppOverlay(child: child ?? const SizedBox.shrink()),
                ),
                ...
                routes: {
                  ...
                  '/quiz-take': (_) => const QuizTakeScreen(),
                  '/teacher-quiz-create': (_) => const TeacherQuizCreateScreen(),
                  '/teacher-quiz-results': (_) => const TeacherQuizResultsScreen(),
                },
              ),
            );
          },
...
class _AppOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isAuthPage = routeName == '/' || routeName == '/login' || routeName == '/register';

    return Stack(
      fit: StackFit.expand,
      children: [
        child,
        if (!isAuthPage) const WhatsAppFloatingButton(),
      ],
    );
  }
}

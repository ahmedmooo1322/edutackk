    ...
    return ListView(
      ...
      children: [
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(context.tr('adminTools'), style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w800)),
                  const SizedBox(height: 6),
                  Text(context.tr('adminSwitchHelp'), style: Theme.of(context).textTheme.bodySmall),
                  const SizedBox(height: 10),
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: [
                      FilledButton.icon(onPressed: () => _switchAdminMode('admin'), icon: const Icon(Icons.admin_panel_settings), label: Text(context.tr('switchToAdminMode'))),
                      FilledButton.tonalIcon(onPressed: () => _switchAdminMode('normal'), icon: const Icon(Icons.chat_bubble_outline), label: Text(context.tr('switchToNormalMode'))),
                    ],
                  ),
                ],
              ),
        ...
        OutlinedButton.icon(
          ...
          label: Text(context.tr('requestAccountDeletion')),
        ),
        if (_whatsappEnabled && _whatsappNumber.isNotEmpty) ...[
          const SizedBox(height: 12),
          FilledButton.icon(
            onPressed: _contactAdminWhatsapp,
            icon: const Icon(Icons.chat),
            label: Text(context.tr('contactAdminActivation')),
          ),
        ],
        ...
        Center(
          child: AnimatedOpacity(
            ...
            child: Text(
              ...
              style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w700, color: Theme.of(context).colorScheme.primary),
            ),
          ),
        ),
      ],

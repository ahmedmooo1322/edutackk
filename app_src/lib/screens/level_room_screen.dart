...
Future<void> openRoomAttachment(BuildContext context, Map attachment) async {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (attachment != null) InkWell(onTap: () => openRoomAttachment(context, attachment), child: Text('📎 ${attachment['original_name'] ?? context.tr('openFile')}', style: const TextStyle(decoration: TextDecoration.underline))),
          ],
        ),
      ),
    );

          ...
          children: [
            ...
            ..._questions.asMap().entries.map((entry) {
              ...
              return Card(child: Padding(padding: const EdgeInsets.all(12), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                Row(children: [Expanded(child: Text('${context.tr('question')} ${i + 1}', style: const TextStyle(fontWeight: FontWeight.bold))), DropdownButton<String>(value: q.type, items: [DropdownMenuItem(value: 'written', child: Text(context.tr('written'))), DropdownMenuItem(value: 'mcq', child: Text(context.tr('mcq')))], onChanged: (v) => setState(() => q.type = v ?? 'written'))]),

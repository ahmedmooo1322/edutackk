...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _uploadPhoto() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(res.ok ? context.tr('profilePhotoUpdated') : (res.error ?? 'Upload failed'))));
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text('${stageLabel(stage, lang)} • ${gradeLabel(stage, level, lang)}', textAlign: TextAlign.center),
                ],
              ),
            ),
          ),

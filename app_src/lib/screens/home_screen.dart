...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _homeGreeting(BuildContext context) {
    ...
    final cards = <_HomeCardData>[
      if (_role == 'admin') _HomeCardData(Icons.admin_panel_settings_outlined, context.tr('adminDashboard'), context.tr('adminDashboardSubtitle'), '/admin'),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(_role == 'admin' ? context.tr('adminSupportModeHint') : context.tr('chooseAction'), style: TextStyle(color: Theme.of(context).colorScheme.onPrimaryContainer)),
                      ],
                    ),
                  ),
                ],

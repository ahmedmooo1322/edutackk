...
class _FriendRequestsScreenState extends State<FriendRequestsScreen> {
  ...
  void _openPublicProfile(Map<String, dynamic> s, {bool isFriend = false}) {
    ...
    final status = s['relationship_status']?.toString() ?? (isFriend ? 'friends' : 'none');
    final alreadyFriend = isFriend || status == 'friends';
              ...
              Row(
                ...
                children: [
                  ...
                  if (alreadyFriend)
                    ...
                    IconButton.filledTonal(onPressed: () { Navigator.pop(context); _friend(id); }, icon: const Icon(Icons.person_add_alt_1)),
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      ...
                      if (alreadyFriend) PopupMenuItem(value: 'unfriend', child: Text(context.tr('unfriend'))),
                    ],
                  ),
                ],
              ),
            ...
            ..._results.map((s) {
              ...
              return Card(
                child: ListTile(
                  ...
                  onTap: () => _openPublicProfile(s, isFriend: s['relationship_status']?.toString() == 'friends'),
                ),
              );
            }),
          ] else ...[
            ...
            ..._friends.map((f) {
              ...
              return Card(
                child: ListTile(
                  ...
                  title: Text(name),
                  subtitle: Text(grade),
                  onTap: () => _openPublicProfile(f, isFriend: true),

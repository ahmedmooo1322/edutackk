...
## V6.7.2 / 0.1.6 SDK 36 fix

Updated GitHub Actions workflow to support Android SDK 36 and resolved the "Already watching path" exception during project creation.
